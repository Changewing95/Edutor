...
router.post('/login', UserController.validate('Validation'), UserController.AuthoriseUser,  UserController.CheckIfVerified, passport.authenticate('local', {failureRedirect: 'login', failureFlash : true}), (req,res) => {
